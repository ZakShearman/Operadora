...
/**
 * This file is taken from the Minestom Demo server. See https://github.com/Minestom/Minestom/blob/master/src/test/java/demo/commands/GamemodeCommand.java
 * It is licensed under MIT, not LGPL-2.2
 */
        ...
        if (entities.size() == 0) {
            ...
            if (entity instanceof Player player) {
                if (player == sender) {
                    ...
                    player.sendMessage(Component.translatable("gameMode.changed", gamemodeComponent), MessageType.SYSTEM);
